...
const checkpointPositions = [{ x: 1170, y: proportionalSize(80), z: 1 },
...
const animate = () => {
    //requestAnimationFrame() es una web API que es utilizada para actualizar animaciones
    requestAnimationFrame(animate)
    ctx.clearRect(0, 0, canvas.width, canvas.height)
    platforms.forEach(platform => platform.draw())
    checkpoints.forEach((checkpoint) => checkpoint.draw())
    player.update()
    // Placeholder for future logic when player is left of 400
