<script>
  /* cuando se quiere que el componente tome props como atributos
    se declaran los props de la siquiente manera, esto tambien se usa
    cuando el componente es contener*/
